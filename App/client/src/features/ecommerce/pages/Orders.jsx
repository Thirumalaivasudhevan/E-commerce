              ...
              <tbody className="divide-y divide-gray-50">
                {orders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-5">
                      <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${order.status === 'paid' ? 'bg-green-100 text-green-600' : 'bg-amber-100 text-amber-600'
                        }`}>
                        {order.status}
                      </span>
                    </td>
          ...
          <div className="p-8 space-y-10 animate-in fade-in zoom-in-95 duration-300 print:p-0 print:m-0" id="invoice-content">
            <div className="flex justify-between items-start">
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-gray-900 tracking-tighter">Nexus Enterprise OS</h3>
